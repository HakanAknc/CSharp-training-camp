...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Alınan Ürün: Patates - " + "Birim Fiyatı: " + applePrice + " - Gramaj: " + potatoGram + " - Toplam Tutar: " + potatoTotalPrice);
            ...
            //Console.WriteLine("Alınan Ürünlerin Toplamı : " + shoppingTotalPrice + " TL");
            ...
            //Console.WriteLine("***** CSharp Havva Yolları Yolcu Bilgisi *****");
            //Console.WriteLine();
            ...
            //Console.WriteLine("----------------------------");
            //Console.WriteLine("Yolcu TC Kimlik No: " + passengerIdentityNumber + " - Yolcu Adı Soyadı: " + passengerName + " " + passengerSurname + " " + passengerAge + " - Yolcu İl / İlçe: " + passengerDistrict + " / " + passengerCity);
